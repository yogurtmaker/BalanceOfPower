...
public class Game extends AbstractAppState {
    ...
    private ActionListener actionListener = new ActionListener() {
        public void onAction(String name, boolean keyPressed, float tpf) {
            ...
            else if (name.equals("absorb2")) {
                planets[2].absorb(planets[1]);
            } else if (name.equals("attack2")) {
                planets[2].attack(planets[1]);
            } else if (name.equals("infusion2")) {
                planets[2].infusion(planets[1]);
            } else if (name.equals("donation2")) {
                planets[2].donation(planets[1]);
    ...
    public void initialize(AppStateManager stateManager, Application app) {
        ...
        inputManager.addMapping("absorb2", new KeyTrigger(KeyInput.KEY_T));
        inputManager.addMapping("attack2", new KeyTrigger(KeyInput.KEY_G));
        inputManager.addMapping("infusion2", new KeyTrigger(KeyInput.KEY_F));
        inputManager.addMapping("donation2", new KeyTrigger(KeyInput.KEY_H));
        inputManager.addListener(actionListener,new String[]{ "absorb", "attack", "infusion", "donation",
        "absorb2", "attack2", "infusion2", "donation2"});
    }
